...
import com.sidekick.mcp.mention.AtMentionCompleter;
...
final class SidekickCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    SidekickCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
