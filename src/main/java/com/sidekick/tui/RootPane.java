...
import com.sidekick.tui.pane.FileTreePane;
import com.sidekick.tui.pane.InputBar;
...
public class RootPane extends Panel {
     ...
     */
    public RootPane(SidekickConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 ~/.sidekick/history/。");
            return true;
        }
