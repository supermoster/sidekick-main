...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(SidekickConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("Sidekick v16.0.0");
    ...
    public SidekickConfig getConfig() {
        return config;
    }
}
