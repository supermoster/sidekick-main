...
import com.sidekick.tui.history.ConversationSnapshot;
import com.sidekick.tui.pane.CenterPane;
import com.sidekick.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final SidekickConfig config;
    ...
    public TuiSessionController(SidekickConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "Sidekick-tui-agent-runner");
