...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("Sidekick.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("Sidekick_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".sidekick", "runtime").toString();
        }
