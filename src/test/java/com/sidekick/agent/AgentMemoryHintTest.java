...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("Sidekick.memory.dir");
        System.setProperty("Sidekick.memory.dir", tempDir.toString());
        try {
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("Sidekick.memory.dir");
            } else {
                System.setProperty("Sidekick.memory.dir", oldMemoryDir);
            }
        }
    }
